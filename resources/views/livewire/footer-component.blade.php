                            ...
                            <div class="wrap-footer-item twin-item">
                                ...
                                <div class="item-content">
                                    <div class="wrap-vertical-nav">
                                        <ul>
                                            <li class="menu-item"><a href="{{ route('user.dashboard') }}"
                                                    class="link-term">My Account</a></li>
                                            <li class="menu-item"><a href="/shop" class="link-term">Shopping</a></li>
                                            <li class="menu-item"><a href="/cart" class="link-term">My
                                                    Cart</a></li>
                                            <li class="menu-item"><a href="/wishlist" class="link-term">Wish
                                                    list</a>
                                            </li>
                                        </ul>
                                    </div>
        ...
        <div class="coppy-right-box">
            <div class="container">
                <div class="coppy-right-item center-section">
                    <p class="coppy-right-text">Make with <i class='fa fa-heart text-danger'></i> by Abdulaziz
                        abdulkader</p>
                </div>
            </div>
        </div>
