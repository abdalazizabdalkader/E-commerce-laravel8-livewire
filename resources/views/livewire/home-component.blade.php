    ...
    <div class="container">
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img
                            src="{{ asset('assets/images/digital-electronic-banner.jpg" width="1170" height="240') }}"
                            alt=""></figure>
                </a>
            </div>
                            ...
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container"
                                ...
                                @foreach ($lproducts as $lproduct)
                                    <div class="product product-style-2 equal-elem ">
                                        ...
                                        @if($lproduct->sale_price > 0 && $sale_date->status == 1 && $sale_date->sale_date > Carbon\Carbon::now())
                                            <div class="group-flash">
                                                <span class="flash-item sale-label">sale</span>
                                            </div>
                                            <div class="product-info">
                                                <a href="{{route('product.details',['slug'=>$lproduct->slug])}}" class="product-name"><span>{{$product->name}}</span></a>
                                                {{-- <div class="wrap-price"><span class="product-price">${{$product->regular_price}}</span></div> --}}
                                                <div class="wrap-price">
        ...
        <div class="wrap-show-advance-info-box style-1">
            ...
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img
                            src="{{ asset('assets/images/fashion-accesories-banner.jpg" width="1170" height="240') }}"
                            alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
                    ...
                    <div class="tab-contents">
                        ...
                        <div class="tab-content-item {{$key == 0? 'active':''}}" id="category_{{$category->id}}">
                            <div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
                                @php
                                    $c_products = DB::table('products')->where('category_id',$category->id)->get()->take($NumOfProduts);
                                @endphp
                                @foreach ($c_products as $c_product )
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{route('product.details',['slug'=>$c_product->slug])}}" title="T-Shirt Raw Hem Organic Boro Constrast Denim">
                                                <figure><img src="{{ asset('assets/images/products') }}/{{$c_product->image}}"
