            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <a href="{{route('user.orders')}}" class="btn btn-success btn-sm pull-right ">My Order</a>
                            <a class="btn btn-warning btn-sm pull-right" style="margin-right:30px" wire:click.prevent='cancelOrder'>Cancel Order</a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="wrap-iten-in-cart">
                        ...
                        <ul class="products-cart">
                            ...
                            <li class="pr-cart-item">
                                ...
                                <div class="price-field sub-total">
                                    <p class="price"><a class="link-to-product" href="{{route('user.review',['order_item_id'=>$item->id])}}">Write Review</a></p>
                                </div>
                                @endif
                                {{-- <div class="delete">
