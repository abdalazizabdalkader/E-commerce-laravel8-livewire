                ...
                <div class="row">
                    <div class="col-md-4">
                        @if ($user->profile->image)
                            <img src="{{asset('assets/images/profile')}}/{{$user->profile->image}}" width="100%" height="75%">
                        @else
                    ...
                    <div class="col-md-8">
                        ...
                        <p><b>Zipcaode: </b>{{$user->profile->zipcode}}</p>
                        <a href="{{route('user.editprofile')}}" class="btn btn-primary pull-right">Update</a>
                    </div>
                </div>
            </div>
        </div>
